...
# CODE FOR CALCULATING DISTANCE -- Focul Length Based
...
def distanceToCamera(knownHeight, focalLength, pixelHeight):
	return (knownHeight * focalLength) / pixelHeight

def distanceToCameraThroughRadius(radius):
	return (-2.39*(radius) + 78.3)
